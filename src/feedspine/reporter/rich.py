...
logger = get_logger("feedspine.reporter.rich")
...
class RichProgressReporter:
    ...
    def __init__(
        ...
        if not RICH_AVAILABLE:
            raise ImportError("Rich progress reporter requires the 'rich' package. Install with: pip install rich")
    ...
    def finish(self, success: bool) -> None:
        ...
        # Print summary
        elapsed = datetime.now(UTC) - self._stats["started_at"]
