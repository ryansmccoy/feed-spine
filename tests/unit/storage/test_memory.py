...
class TestMemoryStorageRecordSightingTracking:
    ...
    async def test_record_sighting_on_existing_updates_fields(self, storage: MemoryStorage) -> None:
        ...
        # Use >= since timestamps may be identical if operations complete in same microsecond
        assert updated.last_seen_at >= record.first_seen_at

    async def test_record_sighting_on_existing_preserves_first_seen(self, storage: MemoryStorage) -> None:
    ...
    async def test_record_sighting_on_existing_nonexistent_returns_none(self, storage: MemoryStorage) -> None:
    ...
    async def test_stored_record_has_sighting_fields(self, storage: MemoryStorage) -> None:
