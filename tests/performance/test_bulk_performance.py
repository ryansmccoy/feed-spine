...
class TestMemoryStoragePerformance:
    ...
    @pytest.mark.slow
    @pytest.mark.skip(reason="MemoryStorage API changed - needs exists_by_natural_key method")
    ...
    @pytest.mark.slow
    @pytest.mark.skip(reason="MemoryStorage API changed - needs record_sighting_on_existing method")
