...
def main():
    ...
    sensor_reading = {"timestamp": "2024-01-15T10:30:00Z", "temperature": 72.5, "humidity": 45.2, "sensor": "room-1"}
    ...
    print("  Fields: author + published_date + title")
    ...
    print("  Content hash of 100-field dict:")
