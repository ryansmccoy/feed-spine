...
type: guide
status: active
tags: [feedspine, storage, backend]
created: 2026-01-15
updated: 2026-06-15
---
...
class StorageBackend(Protocol):
    ...
    async def store_batch(
        ...
        *,
        ...
        """Store multiple records efficiently. Returns count stored."""
        ...
    ...
    async def delete_batch(
        ...
        *,
        ...
        """Delete multiple records efficiently. Returns count deleted."""
        ...
```

!!! note
    The actual protocol is composed from three smaller protocols:
    `RecordStore`, `SightingStore`, and `StorageLifecycle`. You can
    implement only the subset you need for narrower type-hints.
...
- [Feeds and Sources](../concepts/feeds-and-sources.md) - Core concepts
- [Temporal Provenance](../concepts/temporal-provenance.md) - Bi-temporal data model
